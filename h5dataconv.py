...
def create_h5_dataset(image_dir, output_filename, img_shape=(256, 256, 3)):
...
if __name__ == '__main__':
    ...
    create_h5_dataset(train_image_dir, 'data/train_small.h5')
    create_h5_dataset(val_image_dir, 'data/val.h5')
